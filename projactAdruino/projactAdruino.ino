...
const char* ssid = "TP-Link_FBAE";
const char* password = "51306069";
//======================================== 
...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin("http://192.168.0.101/Final_project/getdata.php");  //--> Specify request destination
    ...
    http.begin("http://192.168.0.101/Final_project/updateDHT11data_and_recordtable.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
